...
A combination of the analysis between the changes to APIs, Lehman's laws and the software evolution categories \cite{chapin2001types} (!!!cites) allowed us to answer RQ1. The ability to answer RQ1 was the basis upon which we determined the answer to RQ2. 
