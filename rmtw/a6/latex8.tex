...
To reduce risks of research bias and human error, the data collection was performed by both researchers individually and indepenedtly. If the data differed, the cause was investigated and resolved. As part of the collection phase, the data were input into tables and spreadsheets, according to the API version.
...
Following the analysis of the archival data, the results of the interviews were analysed. The interviews were analysed using the same approach taken for the archival data. The results of this analysis was then compared and correlated with the results of the code analysis. 

We took the same approach (roles/double stuff) as in the collection to reduce human rerror + reseach bias.  
