...
The frequency of A, B and C faults found were tabularised against the groups which found them. An example of this is found in table 3. In order to determine if they do find the same faults, a Chi-Square test of independence was performed on the tabulated results.
