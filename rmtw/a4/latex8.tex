...
As evident from the tests, and as can be seen in Table 4, the results for H\textsubscript{Eff} and H\textsubscript{Rate} are similar. Both show that there is a difference between the two inspection methods, and both show greater results for CL.

%% ctrl+F for "exactly  and why one inspection process"
