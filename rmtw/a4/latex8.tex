...
\begin{table}
	...
	\hline
	UC & 36 & 40 & 35 & 4.61hthth & 3.5 & 0.12 \\
	\hline
...
Given that H\textsubscript{Eff}, H\textsubscript{Rate} and H\textsubscript{Fault} all reject their null hypothesise, we can assume that there is a noticeable difference between the two inspection methods.
