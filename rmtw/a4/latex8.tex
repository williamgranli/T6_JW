...
Note: We were a bit unsure whether to only analyse the tests with help of the p-value or analysing the p-value together with test result and critical-value was the correct. We decided to do the latter and would like feedback on this. 
