...
The benefits of MDSD have consistently been reported in academia . Many large companies such as Ericsson, Volvo and ABB also use MDSD as a part of their development chain. In industry, however, MDSD struggles to make a (full) (x-wide) (XXX) breakthrough and it is mostly used for niche systems such as embedded and safety-critical systems.

\SubSection{Statement of the Problem}
The selection of development process, programming language and programming paradigm has a high impact on the development speed depending on what the system requirements are and in which environment the system is developed.

Selecting for example MDSD for the wrong system and setting may have a very negative impact on development speed, quality and maintainability. Since there seems to be a consensus in academia that MDSD is the future, and that most large software companies choose not to adopt MDSD, there is a need to methodically investigate the existing literature in which studies of the adoption of MDSD, and advantages and disadvantages of MDSD. 
...
What is the actual result, is it good or bad?

Why do they contradict, environment vs system?
