...
Mention criteria for pool of companies and clarify this a bit.
Rephrase the first two sentences
...
#Clarifications on terms for MC/MDD
...
3-3 Clarify how and what department is chosen, i.e. we only looked at EPG so don't make it sound like we did something else.
...
#Bit more explanation for distinction between the roles and phrasing of the sentence
...
#Add initially, tandem implies something else, add more detail here, explaining the analysis more, how the data is constructed, what tools are used and how it's processed. i.e. more detail about spreadsheets and tables.
...
#Revisit the triangulation period
...
%Recap question, describe the interview and questions
%Timeline could be created and added
