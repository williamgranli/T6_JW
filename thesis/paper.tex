...
With this study, we conclude that studying API evolution with help of existing theories, provides a new and structured approach to the field of API evolution. Our study shows that functionality is the largest driving force of change in the evolution of APIs. It also concludes that APIs do not change invariantly, and that maintenance of an API rather is infrequent and sporadic. This finding lead us to invalidate Lehman's law of Conservation of Organisational Stablity in the context of APIs. 
