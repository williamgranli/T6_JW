...
Once the preliminary groups of changes were identified, we had to identify what was different between the two versions. %%Preliminary groups=?, "had to", what was different"=not descriptive enough
