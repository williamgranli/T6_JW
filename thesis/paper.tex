...
The goal of the study was twofold. Firstly, the aim was to explore what the driving forces behind API evolution are, and secondly, to validate the results' level of correctness by comparing our findings with the case company's explanation of the changes. With this information, we could determine to what extent these change decisions can be reverse engineered. 
%6Why this is important for the case company.
...
%I would suggest that paragraph #6 is merged with paragraph 3. (I.e. move #6 in between #3 and #4). Otherwise we have a purpose in two places and the most important part of the purpose in the end of the intro, which isn't good. 

%The first sentence of paragraph 6 is very subjective and doesn't really add much

%I also think the gap (#4) has to be re-written. Right now it doesn't say much at all. And the 2nd sentence makes no sense at all (2refs="well-explored" and 1ref="few")

%Otherwise really good... like the #6 a lot
