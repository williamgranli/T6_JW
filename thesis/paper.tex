...
Evolving a software system is a precipitous activity. Many software evolution theories have been created to assist changing systems, however, as modern systems make greater use of APIs, a question must be asked: do these theories apply to the evolution of APIs? (!!!what is driving the evolution of APIs? - Might fit better with the title?)
%Other studies
Studies have investigated why changes are made to APIs and how these changes affect systems, but they do not attempt to understand the driving forces behind the evolution of an API, according to software evolution theories. Understanding the driving forces of API evolution can potentially improve API design and aid communication between all aspects of a system's feedback loop.
% How do we do it?
