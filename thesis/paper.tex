...
% 1st. author
\alignauthor
John Burchell and William Granli\\
       \affaddr{Computer Science and Engineering}\\
       \affaddr{University of Gothenburg}\\
       \email{john.a.burchell@gmail.com},  \email{william.granli@gmail.com}
% 2nd. author
%\alignauthor
%William Granli\\
%       \affaddr{Computer Science and Engineering}\\
...
%Results
The results of this analysis show that the largest driving force of API evolution is the desire for new functionality. Our findings which show that changes happen sporadically, rather than continuously, invalidate a law of software evolution in the context of APIs \eric{name of the law?}. 
We also found that it is possible to reverse engineer change decisions and in doing so, identified that the feedback loop of an API is the most important area of improvement. 
\end{abstract}
...
This section \chg{will present}{presents} the results of our study and is structured around the research questions. Each section begins with a summary of the results and a subsequent in depth description of the findings.
...
%Lehman Intro
Our analysis of the results related to \textbf{RQ1} showed that seven out of the eight laws \ins{of Lehman} \cite{lehman90sview} do apply to APIs. 
