...
%Other studies
Other studies have investigated why changes occur to APIs and how these changes affect systems, however, they do not attempt to understand the driving forces behind the evolution of the API according to software evolution theories. Understanding the driving forces of API evolution can potentially improve API design and aid communication between all aspects of a system's feedback loop.
% How do we do it?
