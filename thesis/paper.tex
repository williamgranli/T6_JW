...
%%Describe the change 
The final re-implementation updated the parameter setting features of the API. This particular module had very few changes to its functionality except for bringing into line, once again, with the new standard.
...
\smallskip \noindent
\textbf{Why don't all theories apply?  }
Try explain what the reason might be, by comparing APIs to normal systems. 
(Complexity and quality) These apply, but it seems that they are not very important compared to for exmaple functionality. Maybe they are true to a lesser extent compared to normal systems. 
...
List the ones that we found a lot of evidence  (the most true: 6,7) (1, 3, 5) and explain why they are true by linking it to RQ1 results
