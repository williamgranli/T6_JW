...
%%What she said
The interviewee did shed some light onto why this change occurred. In order to continue using this feature in version 2.0 and in newer versions of the camera hardware, it would have to be re-implemented. An impact assessment was undertaken to determine if the removal of the function would be costly. Ultimately it was deemed appropriate and the function was removed from the API.
