...
4
This threat has been counteracted by following a well-reputed guide to case studies \cite{runeson}, and by using analysis methods \cite{grounded} which are conventional. 
The analysis of the data is based around existing theories which should also help reproducibility.
The interview was semi-structured and largely based around the categories of software maintenance and Lehman's laws, which should help reproducibility. 
