...
William Granli and John Burchell\\
       ...
       \email{william.granli@gmail.com},  \email{john.a.burchell@gmail.com}
% 2nd. author
%\alignauthor
%William Granli\\
%       \affaddr{Computer Science and Engineering}\\
...
%\and
% 3rd. author
\alignauthor Imed Hammouda and Eric Knauss\\
\affaddr{Computer Science and Engineering}\\
\affaddr{Chalmers $\mid$ University of Gothenburg}\\
\email{\{imed.hammouda,eric.knauss\}@cse.gu.se}
% 4th 
...
%Purpose, general
Modifications to deployed APIs may negatively impact its users. It is therefore important to investigate why these changes occur. Understanding the motives behind the \newline changes could help API architects to prevent potential future changes to their APIs. Before industry can safely include such information in their feedback loop, we must critically assess to what degree we can reverse engineer such motives. 
...
\begin{table}
       ...
       \begin{tabular}[ht]{l|c}
              ...
              Enhancive     & Inclusion of new functionality                 \\ \hline
...
%Codes
To analyse the data, each change identified in the spreadsheet was coded based on which module the change occurred in and based on if the change added, removed, modified or did not affect functionality. 
%Concepts
...
%Categories
These concepts were then grouped into categories which were based on common patterns between the concepts. An example of a pattern found during the analysis was that several concepts followed the pattern of adding new functionality.    
%Theory
...
\textbf{Updative  }
%Define
Updative changes are defined to be changes to documentation of a system that are made to conform with changes in the code. 
%Data and example
...
\textbf{Reformative  }
%Define
Reformative changes are defined to be \newline changes that update the documentation to the stakeholders needs. An example of such a change is that the structure of the documentation is changed. 
%Data and Example
...
\subsection{Reverse Engineering Change Decisions}
