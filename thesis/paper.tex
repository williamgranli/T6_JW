...
%%What she said 
%%Re-write this... the main reason was functioanlity and not usability stuff XXX
...
The interviewee outline that the previous version of axevent, event, was deprecated in favour of a redesigned event system. This redesign was also a good opportunity to implement the new interface design. 
