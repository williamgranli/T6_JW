...
1. 
       ...
       %Answer to RQ
       Functionality is the main driver for change, and it catalyses other changes

       %Point to results
       relate to enhancive types
       relate to functionality related laws

       %Relate to literature
       Refute refactorings paper
