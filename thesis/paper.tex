...
\begin{abstract}
%Motivation
Evolving an Application Programming Interface (API) is a precipitous activity, mainly because of the great implications modifications can have on the users of it. As the usage of APIs increases, software development organisations must take an empirical and scientific approach to the way they manage the evolution of their APIs. 
%Problem
If no attempt at analysing or quantifying the evolution of an API is made, there will be a lacking understanding of the evolution, and possible improvements to the maintenance strategy will be difficult to identify. We believe, that long-standing software evolution theories can provide additional insight to the field of APIs, and be of great use to companies maintaining APIs. 
%Method
...
\begin{table}
       ...
       \begin{tabular}[ht]{p{3in}}
              ...
              \textbf{Phase 1: Generate Hypotheses}
              
              \begin{enumerate}
              \item Inspect source code  
              \item Inspect accompanying documentation 
              \item Generate Hypotheses 
              \item Conduct Interview 
              \item Analyse source code
              \end{enumerate} \\ 


              
              \textbf{Phase 2: Confirm Hypotheses} 
              
              \begin{enumerate}
              \item Analyse interviews 
              \item Classify trends according to types 
              \item Compare classifications against interview responses 
              \item Analyse from software evolution theory point of view 
