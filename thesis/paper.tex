...
1
Theories not applying
Only analysing changes between two version
Not investigating the implementation of the code (i.e. only headers were analysed)

2
Counteracted: 
Triangulation by checking both code, documentation and interviewing.

Remaining: 
Only interviewing architects. Maybe business ppl need to be invited to find intents.
Not interviewing partners

3
The results should be generalisable to a large extent to any API designers
Should be especially useful for platform/embedded APIs

4
This threat has bene counteracted by following a well-reputed guide to case studies \cite{runeson}, and by using analysis methods \cite{grounded} which are conventional. 
The analysis of the data is based around existing theories which should also help reproducability.
The inteview was semi-structured and largely based around the categories of software maintenance and Lehman's laws, which should help reproducability. 
