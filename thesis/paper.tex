...
% 1 - Desire for new functionality 
% 2 - Push for new functionality from partners
% 3 - Desire for a well designed API, interface improvements
% 4 - Desire to have a maintainable API
% 5 - The majority of changes added to the API, rather than removed - Seems to support the paper which said most changes are refactorings?
%
