...
In order to answer \textbf{RQ1}, we categorised the changes based on the 12 maintenance categories \cite{chapin2001types}. Initially, we created predictions of the changes from inspecting the source code and accompanying documentation. Following the interview, we compared our predictions with the actual motive which was deduced from the interviewee's reasoning. Table \ref{table:Categories} shows the predicted and actual maintenance categories.

The changes have been divided up into four specific categories, namely: new, modified, removed and general trends. New and modified changes concern additions of or modifications to modules and removed changes is functionality which have been removed entirely without being deprecating or replaced by new implementations. General trends are broad changes which do not directly affect functionality. 
...
The changes have been divided up into four specific categories, namely: new, modified, removed and general trends. New and modified changes concern additions of or modifications to modules. Removed changes are functionality which have been removed entirely without being deprecated or replaced by new implementations. General trends are broad changes which do not directly affect functionality. 
...
\section{Discussion}
Our results have provided valuable insight to the motives behind the evolution of an API. The results show that APIs definitely can be studied from the point of view of old evolution theories. Based on the result, we have formulated the subsequent outcomes. 
...
\end{document}
>>>>>>> d390a4497e7e76430c2b9cdf1432c4a1597dcfd1
