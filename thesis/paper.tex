...
%define what an API is for us
%we consider APIs to be systems because x y z \cite{761853,5733835} 
%Introduce different layers of an API.
%Headers / Interfaces
%Implementation
%"Middle Layer"
