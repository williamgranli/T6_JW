...
%Results
The results of this analysis show that the largest driving force of API evolution is the desire for new functionality. Our findings which show that changes happen sporadically, rather than continuously, invalidate the law of Conservation of Organisational Stability in the context of APIs. We also found that it is possible to reverse engineer change decisions and in doing so, identified that the feedback loop of an API is the most important area of improvement. 
\end{abstract}
