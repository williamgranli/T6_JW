...
\section{RQ2 Lehman}
The results related to \textbf{RQ2} are structured around each of Lehman's laws and to what extent our findings show that the laws apply to platform APIs. The summary of our findings can be seen in Table \ref{table:lehman}. 
...
\subsection{Increasing Complexity} \label{sec:law2}
...
\subsection{Self Regulation} \label{sec:law3}
...
This leads to the conclusion (!!probably avoid that word in discussion) that the inclusion of new features and the maintainability of an API are two very strong drivers of API evolution.
