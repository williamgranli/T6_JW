...
What this means for industry:
	...
	Obvious benefit for Axis is that the more features == higher value for their camera. If they have many applications being developed by parters (In part due to the fact they have added more features to the camera API) then the value of their hardware and software will increase. This is probably the case for many other APIs but would need to be studied in some detail to determine the truth behind the statement.
