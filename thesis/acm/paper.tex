...
\textbf{Background } 
Studies of the motives and drivers behind modifications to APIs have been done before, but platform APIs are, so far, unexplored. Previous work has also not studied APIs from the perspective of widely recognised software evolution theories, such as the Categories of Software Maintenance and Lehman's laws of software evolution. 
